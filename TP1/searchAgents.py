...
class CornersProblem(search.SearchProblem):
    ...
    def getSuccessors(self, state):
        ...
        self._expanded += 1  # Increment expanded node count for debug
        return successors
...
def cornersHeuristic(state, problem):
    ...
    state: a tuple (pacman_position, visited_corners)
    ...
    while unvisited_corners:
        ...
        nearest_distance, nearest_corner = min(distances)
...
def foodHeuristic(state, problem: FoodSearchProblem):
    ...
    def getMazeDistance(firstPosition, secondPosition):
        if (firstPosition, secondPosition) not in cached_distances:
            distance = mazeDistance(firstPosition, secondPosition, problem.startingGameState)
            cached_distances[(firstPosition, secondPosition)] = distance
            cached_distances[(secondPosition, firstPosition)] = distance
        return cached_distances[(firstPosition, secondPosition)]
